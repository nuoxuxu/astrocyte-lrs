...
workflow {
    ...
    GET_QUALITY_METRICS(params.ribotie_training_outputs, PhyloCSFpp_db, RUN_ORFANAGE.out.orfanage_proteins, pfamdb, SQANTI_AND_FILTER_BY_EXP.out.subset_corrected_fasta, file(params.Human_coding_transcripts_CDS), file(params.Human_noncoding_transcripts_RNA), file(params.Human_logitModel))
