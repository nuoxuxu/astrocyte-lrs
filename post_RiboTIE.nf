...
workflow {
    ...
    channel.value(file("nextflow_results/ribotie/mid_stringency/merged/ribotie_res_merged.gtf")).set { ribotie_input_gtf }
    ...
    FILTER_RIBOTIE(ribotie_input_gtf, channel.value(file(params.ribotie_cpm1_3sample)), final_fasta, final_expression, final_classification, ref_genome_fasta)
